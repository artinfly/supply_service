# Generated by Django 6.0.2 on 2026-07-28 16:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # до фикса normalize_staging повторная загрузка файла за один день
        # дублировала снимок по (upload_date, igk, cfo, year_col) — без чистки
        # AddConstraint ниже не применится на базах со старыми дублями
        migrations.RunSQL(
            sql="""
